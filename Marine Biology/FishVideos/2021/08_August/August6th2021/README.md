...
# Video for today (Friday, August 6th 2021)

This file goes over info about todays fishtank video, from Friday, August 6th 2021.
...
Videos are not yet available on GitHub, as todays video (263.997,077,942 MiB/276,820,663 MB) <!-- {{-++CALCULATION ERROR, MB IS CORRECT, MIB ISN'T++-}} Removed from public view, as it is too annoying. I don't know how to better describe the issue !--> significantly exceeds GitHubs upload limit (25.000 MiB/26.214 MB)

I forgot to list the size of yesterdays (Thursday, August 5th 2021) video into the document itself, so I will list it here: (521.913,528,442 MiB/547,266,405 MB) 

### Calculation source (DuckDuckGo)

Calculated using DuckDuckGos built-in advanced unit calculator [Try it out yourself by clicking/tapping here](https://duckduckgo.com/?q=276%2C820%2C663+bytes+to+MiB&t=ffab&ia=answer) <!-- Note to self: if not done already, cut the link out and place the correct one in, show you care enough to put some additional effort besides the default modified template on most days. You should think slightly better of yourself for thisl !-->

***

## File info

**File version:** `1 (Tuesday, August 10th 2021 at 9:19 pm)`
