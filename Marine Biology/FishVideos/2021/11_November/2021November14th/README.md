...
# Video for today (2021, Sunday, November 14th)

This file goes over info about todays fishtank video, from 2021, Sunday, November 14th
...
<!-- TODO NOTE:
Record good video of the clean fishtank with its calming, sleek audio
!-->
...
Videos are not yet available on GitHub, as todays video (348.983,764,648 Mebibytes (MiB) | 365,936,103 Megabytes (MB) <!-- {{-++CALCULATION ERROR, MB IS CORRECT, MIB ISN'T++-}} Removed from public view, as it is too annoying. I don't know how to better describe the issue !--> significantly exceeds GitHubs upload limit (25.000 MiB/26.214 MB)
...
**File version:** `1 (Monday, 2021 November 15th at 12:07 am)`

**File type:** `Markdown document (*.md, *.mkd, *.mdown, *.markdown)`

**Line count (including blank lines and compiler line):** `769`
